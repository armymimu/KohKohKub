...
function getOfficialVerificationLinks(text) {
  ...
  if (isLoan) {
    return {
      ...
      links: [
        {
          label: '1. ตรวจสอบใบอนุญาตสถาบันการเงินและ Non-Bank (ธปท.)',
          url: 'https://www.bot.or.th/th/our-roles/financial-institutions/check-license.html',
        },
      ],
      hotline: 'ศูนย์คุ้มครองผู้ใช้บริการทางการเงิน (ศคง.) โทร 1213',
    };
  }
