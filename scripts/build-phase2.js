...
<div class="wrap">
  <div class="ad-slot" id="ad-top">
    <!-- AdSense / Sponsor Slot Placeholder -->
    <div style="font-weight:bold;color:#334155;margin-bottom:4px;">🛡️ เช็คก่อนโอน ปลอดภัยทุกการใช้จ่าย</div>
...
<footer>
  <div class="wrap">
    ...
    <p>© 2026 เช็คก่อนโอน — ระบบตรวจสอบความปลอดภัยก่อนทำธุรกรรมออนไลน์</p>
  </div>
</footer>
...
const pCheck = renderPage({
  metaTitle: 'เช็คเลขบัญชีคนโกง ตรวจสอบบัญชีมิจฉาชีพ บัญชีม้า ฟรี — เช็คก่อนโอน',
  desc: 'เช็คเลขบัญชีคนโกง ตรวจสอบประวัติมิจฉาชีพ บัญชีม้า ก่อนโอนเงิน ตรวจสอบผ่าน LINE ตอบกลับทันทีใน 3 วินาที ป้องกันการโดนโกงทุกรูปแบบ',
  keywords: 'เช็คเลขบัญชีคนโกง,ตรวจสอบบัญชีคนโกง,เช็คบัญชีม้า,เช็คคนโกง,blacklistseller,เตือนภัยโอนเงิน,เช็คก่อนโอน',
  canonical: '/check-account.html',
  headerH1: 'เช็คเลขบัญชีคนโกง<br>ตรวจสอบบัญชีมิจฉาชีพ',
  headerLead: 'วางเลขบัญชีในไลน์ รู้ผลทันทีใน 3 วินาที<br>ตรวจความเสี่ยง ฐานข้อมูลคนโกง และประวัติทั่วอินเทอร์เน็ต',
  contentHtml: `
  <h2>วิธีเช็คเลขบัญชีคนโกงง่ายๆ ใน 1 นาที</h2>
  <ol class="step-list">
    <li><b>ก๊อปปี้เลขบัญชี</b> ที่ผู้ขายหรือคู่สนทนาส่งมาให้</li>
    <li><b>ส่งเข้า LINE บอท "เช็คก่อนโอน"</b> ระบบจะค้นหาความถี่การถูกสอบถามและประวัติทันที</li>
...
const pHotel = renderPage({
  metaTitle: 'เตือนภัยเพจที่พักปลอม หลอกโอนค่ามัดจำห้องพัก — เช็คก่อนโอน',
  ...
  keywords: 'เพจที่พักปลอม,โกงที่พักเกาะล้าน,โกงมัดจำที่พัก,รีสอร์ทปลอม,เช็คที่พักก่อนโอน,เพจปลอมพัทยา',
  ...
  <div class="box-card">
    ...
    <p>ก่อนโอนมัดจำที่พัก ให้ขอเบอร์โทรศัพท์บ้านหรือเบอร์ตรงของที่พักโทรตรวจสอบ หรือนำเลขบัญชีมาเช็คในบอท "เช็คก่อนโอน"</p>
  </div>`
});
...
const pCar = renderPage({
  metaTitle: 'เตือนภัยโกงเช่ารถ มอเตอร์ไซค์ รถตู้ หลอกมัดจำ — เช็คก่อนโอน',
...
const pTicket = renderPage({
  metaTitle: 'เตือนภัยโกงตั๋วคอนเสิร์ต บัตรแฟนมีต ตั๋วเดินทาง — เช็คก่อนโอน',
  ...
  <div class="box-card">
    ...
    <ul>
      ...
      <li>นำเลขบัญชีและชื่อผู้ขายมาวางเช็คใน LINE @เช็คก่อนโอน</li>
    </ul>
  </div>`
});
...
const pInvest = renderPage({
  metaTitle: 'เตือนภัยหลอกลงทุน เทรดหุ้น ปั่นยอดวิว แชร์ลูกโซ่ — เช็คก่อนโอน',
  ...
  headerLead: 'การันตีกำไรวันละ 500-3,000 บาท ไม่มีอยู่จริงในโลก<br>รู้ทันกลลวงก่อนสูญเงินก้อนโต',
  contentHtml: `
...
const pLoan = renderPage({
  metaTitle: 'เตือนภัยเงินกู้ออนไลน์ หลอกโอนค่ามัดจำ ค่าปลดล็อคยอด — เช็คก่อนโอน',
  ...
  headerLead: 'กู้เงินแต่ต้องโอนเงินไปก่อน = โดนหลอก 100%<br>สถาบันการเงินที่ถูกกฎหมายจะไม่เรียกเก็บเงินก่อนอนุมัติสินเชื่อ',
  contentHtml: `
...
const pShop = renderPage({
  metaTitle: 'เตือนภัยซื้อของออนไลน์ โดนโกง โอนแล้วบล็อก ส่งของไม่ตรงปก — เช็คก่อนโอน',
  desc: 'วิธีซื้อของออนไลน์ไม่ให้โดนโกง เช็คเลขบัญชีพ่อค้าแม่ค้าก่อนโอนเงิน ตรวจประวัติการส่งของ ป้องกันสินค้าไม่ตรงปก',
  keywords: 'โกงซื้อของออนไลน์,โอนแล้วบล็อก,สินค้าไม่ตรงปก,เช็คประวัติคนขาย,ซื้อของในเฟซบุ๊ก,เช็คก่อนโอน',
  canonical: '/shopping-scam.html',
  headerH1: 'เตือนภัยซื้อของออนไลน์<br>โอนแล้วบล็อก ส่งของไม่ตรงปก',
  headerLead: 'ซื้อของผ่าน Facebook / IG / TikTok ระวังเพจปลอมยิงแอดขายสินค้าราคาถูก<br>เช็คเลขบัญชีและชื่อผู้รับเงินก่อนโอนทุกครั้ง',
  contentHtml: `
...
const pFreeze = renderPage({
  metaTitle: 'วิธีอายัดบัญชีคนโกงทันที สายด่วน 1441 และขั้นตอนแจ้งความ — เช็คก่อนโอน',
  ...
  headerLead: 'โอนเงินแล้วรู้ตัวว่าโดนหลอกโอนเงิน ยิ่งดำเนินการเร็ว ยิ่งมีโอกาสได้เงินคืน<br>ทำตาม 3 ขั้นตอนนี้ทันที!',
  contentHtml: `
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>สถิติการใช้งานและความโปร่งใส — เช็คก่อนโอน</title>
<meta name="description" content="สถิติข้อมูลการตรวจสอบเลขบัญชี จำนวนผู้ใช้งาน และร้านค้าที่ได้รับการยืนยันความปลอดภัยในระบบ">
...
<header>
  <div class="wrap">
    ...
    <p class="lead">รายงานตัวเลขการตรวจสอบความปลอดภัยของชุมชนแบบ Real-time</p>
...
console.log('✅ Successfully built all Phase 2 SEO and stats pages!');
